...
This app is build as a react nanodegree learning project. The purpose of the project to crete individual user pool details using react redux. 
...
## Project Help Utilities from Udacity React & Redux Course
